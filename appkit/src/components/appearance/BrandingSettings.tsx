                ...
                <div className="flex items-center justify-between w-full">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <CardDescription>Core visual elements and splash screen.</CardDescription>
                        </div>
                    </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
                    <div className="space-y-8">
                        ...
                        <div className="space-y-6">
                            <h4 className="text-xs font-bold text-gray-400 uppercase tracking-widest border-b border-gray-100 pb-2">App Identity</h4>
                        ...
                        <div className="space-y-6">
                            <h4 className="text-xs font-bold text-gray-400 uppercase tracking-widest border-b border-gray-100 pb-2">Splash Screen Quick Settings</h4>
