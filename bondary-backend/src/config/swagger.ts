...
const options = {
  definition: {
    ...
    info: {
      title: 'Boundary API',
      version: '1.0.0',
      description: 'Comprehensive API documentation for Boundary family management platform',
      contact: {
        name: 'API Support',
        email: 'support@boundary.com',
        url: 'https://boundary.com/support'
      },
      license: {
        name: 'MIT',
    ...
    servers: [
      ...
      {
        url: 'https://staging-api.boundary.com',
...
export function setupSwagger(app: Application): void {
  ...
  const swaggerUiOptions = {
    ...
    `,
    customSiteTitle: 'Boundary API Documentation',
